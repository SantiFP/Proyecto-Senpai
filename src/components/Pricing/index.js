...
export const Pricing = () => {
    ...
    return (
        ...
        <div className="md:absolute top-40 left-10 xl:ml-24 ">
            ...
            <p className="font-normal text-lg mt-0.5 lg:mb-16">USD 10.50/month</p>

            <div><Link to='./signUp'><button className="boton rounded-lg py-2 px-16  ">SIGN UP NOW</button></Link></div>
